...
const INSERT_QUERY = 'INSERT INTO playerlist(id,PlayerName,Match1, Match2,Match3,Match4,Match5,Match6,Match7,Match8,Match9,timestamp) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?)';
...
cron.schedule('*/1 * * * *', () => {
    ...
    function GettingDataFromExcel() {
        ...
        let send = [];
        fetch('https://sheets.googleapis.com/v4/spreadsheets/1OoePLf5TVUwyYDN0ikV3p6ZniT1bNWkr34_zAwk74aA/values/Sheet1?key=AIzaSyARf7Xk9E_Pp6zwdD1kJu5x_mC3HAxGPgE')
